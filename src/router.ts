...
export type RouteDefinition<Route, T extends Middleware<any ,any>> = { method: HttpMethod, route: Route, middleware: T };

export type ClientRouteDefinition<Route, T extends Middleware<any ,any>> = { method: HttpMethod, route: Route, type: Awaited<ReturnType<T>> };

export function ClientRoute<Route, T extends Middleware<any ,any>>(routeDefinition: RouteDefinition<Route, T>): ClientRouteDefinition<Route, T> {
...
export function Router() {
  return {
    ...
    ): RouteDefinition<Route, CombinedMiddleware<A, B, C, D, E, F, G, H, I, J>> {
