...
import { ImplementedRouteDefinition, InternalError } from './implement';

export function expressify(routeDefinitions: Record<string, ImplementedRouteDefinition<any>>): RequestHandler {
  const router = Router();
